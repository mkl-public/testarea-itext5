 ...
 * @author mkl
 */
public class AddImageInPattern {
     ...
     * </a>
     * <p>
     * This test shows how to wrap an image in a pattern. this may persuade
     * some PDF viewers to not expose a function to copy that image.
     * </p>
     */
    @Test
    public void testAddToPageTest3() throws DocumentException, IOException {
        try (   InputStream resource = getClass().getResourceAsStream("test3.pdf");
                OutputStream result = new FileOutputStream(new File(RESULT_FOLDER, "test3-withImageInPattern.pdf"))  ) {
